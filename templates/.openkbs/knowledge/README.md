...
- If developing new agent, search for run_job.js in the .openkbs/knowledge/examples folder, and implement run_job.js script to provide a backend-to-backend agent invocation 
